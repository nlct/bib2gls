...
Ignore the B<type> field. Default if B<--split-on-type>.

=item B<--no-ignore-type>

Don't ignore the B<type> field. Default unless B<--split-on-type>.

=item B<--split-on-type>
