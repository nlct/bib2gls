...
pdflatex myDoc
\end{verbatim}
(This document assumes \appfmt{pdflatex} for simplicity. Replace
...
(or with the shortcut \cs{GlsXtrLoadResources}).
...
\file{convertgls2bib.jar}. (The library is in a separate 
\href{https://github.com/nlct/texparser}{GitHub repository}
as it's also used by some of my other applications.)
