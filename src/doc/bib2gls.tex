...
the widest names for each hierarchical level. Since it doesn't
know the fonts that will be used in the document or if there
are any custom commands, this option may not work.
...
\optref[\marg{none:copies}]{secondary} the \texttt{copies}
...
treated as \csopt[\marg{}]{match}. That is, no filtering will be
applied.
...
The default is \csopt[\marg{and}]{match-op}.
...
\optref[\marg{recorded and deps}]{selection} and 
\optref[\marg{recorded and ancestors}]{selection} won't pick up the
...
Note that \csopt[\marg{}]{suffixF} sets the suffix to the
empty string. To remove the suffix formation use
\csopt[\marg{none}]{suffixF}.

The default is \csopt[\marg{none}]{suffixF}.
...
Note that \csopt[\marg{}]{suffixFF} sets the suffix to the
empty string. To remove the suffix formation use
\csopt[\marg{none}]{suffixFF}.

The default is \csopt[\marg{none}]{suffixFF}.
