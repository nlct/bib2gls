...
If you use the \isty{glossaries-prefix} package, the \field{prefix}
...
The \cs{append-prefix-field} option allows the automatic insertion of a
...
\item \optfmt{space}: append \ics{space} to the prefix field unless the
field value ends with a character identified by
\csopt{append-prefix-field-exceptions}.
...
by \cs{append-prefix-field-nbsp-match}.
