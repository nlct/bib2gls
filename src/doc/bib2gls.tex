...
spaces. The library method that writes \idx{non-ASCII}
...
can be used to append a \idx{full-stop} to the end of all the
...
to \code{tug} using the \csopt{category} option:
\begin{verbatim}
category=tug
\end{verbatim}
...
space before the parenthesis to \verb*|\ | because some of the
