...
\optfmt{custom} & sort according to \optref[\meta{custom rule}]{sort-rule}
\end{tabular}
\end{table}
...
\subsection{\csoptnv{combine-dual-locations}\csopteqval{value}}
...
\subsection{\csoptnv{dual-abbrventry-map}=\marg{\margm{list1},\margm{list2}}}
...
\subsection{\csoptnv{dual-indexentry-map}=\marg{\margm{list1},\margm{list2}}}
\labelopt{dual-indexentry-map}

This is like \csopt{dual-entry-map} but applies to
\atentryref{dualindexentry} rather than \atentry{dualentry}. 

\subsection{\csoptnv{dual-indexsymbol-map}=\marg{\margm{list1},\margm{list2}}}
...
\subsection{\csoptnv{dual-indexabbrv-map}=\marg{\margm{list1},\margm{list2}}}
...
\subsection{\csoptnv{dual-abbrventry-backlink}\csopteqval{boolean}}
...
\subsection{\csoptnv{dual-indexentry-backlink}\csopteqval{boolean}}
...
\subsection{\csoptnv{dual-indexsymbol-backlink}\csopteqval{boolean}}
...
\subsection{\csoptnv{dual-indexabbrv-backlink}\csopteqval{boolean}}
