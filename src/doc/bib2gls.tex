...
comparator used with the secondary sort.\\
...
the sort value. Note that this just \emph{copies the entry's label}
to the second glossary list rather than creating a duplicate entry. 
This means that all the fields will be identical. If you want groups
in your glossary, the information for the secondary glossary will
be in the internal \field{secondarygroup} field. The \field{group}
field will contain the letter groups for the primary glossary.
...
If this command is defined, the preamble will be adjusted to locally
change the field to \field{secondarygroup}. With older versions, the
group information in the secondary glossary will be the same as for
