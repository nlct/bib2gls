...
This will copy all the selected entries into the glossary
labelled \meta{type} sorted according to \meta{sort} (as
\optref{sort}) using \meta{field} as the sort value.
...
\subsection{\csoptnv{flatten-sort}=\margm{value}}
\labelopt{flatten-sort}

This is a boolean option. The default value is
\csopt[false]{flatten-sort}. 

If \csopt[true]{flatten-sort}, the sorting will ignore hierarchy.
