...
The other entry types recognised by \bibgls\ are listed below.
Each type may have required fields and optional fields. For the
...
If the \field{sort} field is missing, \bibgls\ will fallback on
another value, depending on the entry type. You can override the
field used for sorting with the \optref{sort-field} option.
