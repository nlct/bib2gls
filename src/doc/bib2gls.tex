...
\cs{usepackage}\oarg{T2A}\marg{fontenc}
\cs{usepackage}\oarg{utf8}\marg{inputenc}
\cs{usepackage}\oarg{russian}\marg{babel}
\cs{usepackage}\oarg{record}\marg{glossaries-extra}

\gls{GlsXtrLoadResources}\oarg{
  src = {\cs{detokenize}{\textcyrillicmono{кириллица}}},\comment data in \textcyrillicmono{кириллица.bib}
  selection=all
}
