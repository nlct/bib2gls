...
\end{verbatim}
This will first list the locations for the \optfmt{equation}
counter and then the locations for the \optfmt{page} counter.
...
The \meta{list} value must be non-empty.
Use \csopt[as-use]{loc-counters} to restore the default behaviour,
where the locations are listed in the document order of use,
or \csopt[false]{save-locations} to omit the location lists.
