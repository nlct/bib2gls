...
locations. Remember that you can also use the \sty{glossaries}
package's \cs{glsnoidxloclist}. For example:
\begin{verbatim}
...
then the locations aren't considered consecutive;
   \item\label{itm:decgrp3} If \meta{group-3} of the second pattern match is one more
...
\hyperref[sec:alphmatch]{alpha pattern}. The first location is
