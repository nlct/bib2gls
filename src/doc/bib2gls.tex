...
mapped by \atentryref{dualindexentry}.\tabularnewline
...
\field{dualdescription}). If no \field{name} is given, the dual
...
\csopt[\meta{boolean}]{dual-symbol-backlink}, and
...
\providecommand{\bibglsnewdualindexentry}[4]{%
  \longnewglossaryentry*{#1}{name={#3},#2}{}%
}
\end{verbatim}
...
\providecommand{\bibglsnewdualindexsymbol}[5]{%
  \longnewglossaryentry*{#1}{name={#3},symbol={#4},#2}{}%
}
\end{verbatim}
Note that this definition ignores the \meta{description} argument.
...
\providecommand{\bibglsnewdualindexsymbolsecondary}[5]{%
  \longnewglossaryentry*{#1}{name={#3},symbol={#4},#2}{#5}%
}
\end{verbatim}
