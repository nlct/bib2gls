...
Remember that you can use \ics{newglossary*}
...
Alternatively you can use \ics{newignoredglossary} if you don't
want the glossary picked up by \ics{printunsrtglossaries}.
