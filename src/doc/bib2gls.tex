...
\fieldfmt{unitname}, \fieldfmt{unitsymbol} and \fieldfmt{measurement},
...
as required. The \fieldfmt{unitsymbol} fields all use \ics{si} provided
...
\csopt[true]{interpret-labels-field}.  This means that with this
...
and \exfile{films.bib} it also requires the \ext{bib} files that
