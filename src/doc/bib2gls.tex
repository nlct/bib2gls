...
\section{\cs{bibglsunicodegroup}}
\labelcs{bibglsunicodegroup}

\begin{definition}
\cs{bibglsunicodegroup}\margm{group}\margm{character}\margm{group
codepoint}\marg{character codepoint}
\end{definition}
...
\meta{group}. The \meta{group codepoint} is the decimal code for
\meta{group}. The \meta{character codepoint} is the decimal code for
\meta{character}.
For example:
\begin{verbatim}
@entry{angstrom,
...
\begin{verbatim}
\providecommand{\bibglsunicodegroup}[4]{#1}
\end{verbatim}
