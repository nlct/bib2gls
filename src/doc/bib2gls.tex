...
for standard the internal locations and 
\nosecdef{glsxtrdisplaysupploc}
for supplemental (external) locations. (See \sectionref{sec:supplementalopts}
for more information about supplemental locations.)
