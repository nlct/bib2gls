...
\item \optfmt{locale}: sort the entries according to the operating
system's locale.
...
Note that implicit ranges can't be formed from interlopers,
...
The \meta{group} argument will typically by title-cased unless
\optref[tertiary]{strength}. An exception is made to the
