...
trimming) and by \longarg{trim-fields} (which switches on trimming
for all fields). This option may not be used with
\longarg{trim-only-fields}.

For example, to trim all fields except \field{prefix} and
\field{prefixfirst}:
\begin{verbatim}
bib2gls --trim-except-fields prefix,prefixfirst myDoc
\end{verbatim}
Or
\begin{verbatim}
bib2gls --trim-except-fields prefix --trim-except-fields prefixfirst myDoc
\end{verbatim}
