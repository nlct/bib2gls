...
need to redefine \cs{GlsXtrDualField} as appropriate.
...
stylemods={tree,list}% load glossary-tree and patch styles
]{glossaries-extra}
\end{verbatim}
...
\csopt{sort} method. These labels are stored in the \field{category} 
...
the \idx{postdescriptionhook} can be used. In this case, it iterates
