...
level). Note that only the duplicates are given suffixes with this
setting. The first sort value to be encountered isn't given a suffix.
...
\csopt[category]{sort-suffix} option instead.
