...
\newcommand{\topicxrhandler}[1]{%
 ...
 {\GenericWarning{}{Missing parent for `#1'}}% 
}
...
{%
  ...
  \renewcommand*{\subglossentry}[3]{%
   ...
   {%
     ...
     \glsxtrifhasfield{progenitor}{##2}{\gls{\glscurrentfieldvalue}}{\gls{##2}}%
   }%
   \glsxtrifhasfield{useri}{##2}{\glscurrentfieldvalue}{}%
   \glsxtrifhasfield{note}{##2}%
   {\nolinebreak\hfill\mbox{\footnotesize\glscurrentfieldvalue}}%
   ...
   {%
     \glsxtrifhasfield{progeny}{\glscurrentfieldvalue}% 
     {\par\smallskip\par Topics: 
