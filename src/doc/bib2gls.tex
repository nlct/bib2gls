...
sort-rule={\glsxtrcontrolrules
 ...
 <\glsxtrdigitrules
 <\glsxtrVulgarFractionrules
 <\glsxtrMathItalicGreekIrules
 <\glsxtrGeneralLatinIVrules
 <\glsxtrLatinExtensionIIrules
}
\end{verbatim}
This places the Greek maths symbols (such as \cs{alpha}) before the
...
\GlsXtrLoadResources[
 ...
 <\glsxtrVulgarFractionrules % fraction symbols
