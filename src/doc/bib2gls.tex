...
\verbatiminput{../examples/no-interpret-preamble.bib}
...
\verbatiminput{../examples/bacteria.bib}
...
\verbatiminput{../examples/people.bib}
...
abbreviation-sort-fallback=long
\end{verbatim}
The complete code is listed below. This simple example only
references entries on the first page so all entries just have~1
in the number list. The complete document is shown in
\figureref{fig:sample-bacteria.pdf}.

\verbatiminput{../examples/sample-bacteria.tex}
...
\end{verbatim}
The complete document code is listed below. The four pages of the
document are shown in \figureref{fig:sample-people.pdf}.

\verbatiminput{../examples/sample-people.tex}
