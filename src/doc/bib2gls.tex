...
the locations are separated by \csref{bibglsdelimN} or \csref{bibglslastDelimN}.
...
\csref{glsxtrresourcefile} changes the category code of \code{@} to allow for
...
\csref{glsxtrresourcefile}.) If you have \sty{glossaries-extra} version~1.12, 
...
should begin with \code{\csref{bibglslocprefix}\margm{n}}. The \meta{value} may
...
For example:
\begin{codeenv}
\gls{GlsXtrLoadResources}\oarg{type=main,src=\marg{entries1},loc-prefix=false}
\gls{GlsXtrLoadResources}\oarg{type=main,src=\marg{entries2},loc-prefix}
\gls{GlsXtrLoadResources}\oarg{type=symbols,src=\marg{entries3},loc-prefix=\marg{p.,pp.}}
\end{codeenv}
...
\begin{codeenv}
\gls{GlsXtrLoadResources}\oarg{src=\marg{entries1},loc-prefix=false}
\gls{GlsXtrLoadResources}\oarg{src=\marg{entries2},loc-prefix}
\gls{GlsXtrLoadResources}\oarg{src=\marg{entries3},loc-prefix=\marg{p.,pp.}}
\end{codeenv}
