...
\end{verbatim}
I need to remember to redefine \ics{glsxtrgroupfield} before
displaying the index to this field:
\begin{verbatim}
...
duplicate targets. All references using \cs{gls} etc will link
to the first glossary.
...
\centering
\begin{tabular}{@{}cc@{}}
\frame{\includegraphics[page=1,width=.45\textwidth]{../examples/sample-people.pdf}}&
\frame{\includegraphics[page=2,width=.45\textwidth]{../examples/sample-people.pdf}}\\
\frame{\includegraphics[page=3,width=.45\textwidth]{../examples/sample-people.pdf}}&
\frame{\includegraphics[page=4,width=.45\textwidth]{../examples/sample-people.pdf}}
\end{tabular}
