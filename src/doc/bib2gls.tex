...
and \figureref{fig:sample-multi.pdf2}.

\lstinputlisting[firstline=5]{../examples/sample-multi.tex}

\begin{figure}[p]
\figcontents
{\pdftwocol{../examples/sample-multi.pdf}{4}}
{\caption{\filefmt{sample-multi.pdf} (pages~1 to~4)}}
{fig:sample-multi.pdf}
\end{figure}

\begin{figure}[p]
\figcontents
{\pdftwocol[5]{../examples/sample-multi.pdf}{8}}
{\caption{\filefmt{sample-multi.pdf} (pages~5 to 8)}}
{fig:sample-multi.pdf2}
\end{figure}
