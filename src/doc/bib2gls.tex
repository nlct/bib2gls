...
\newcommand{\argsection}[2][\section]{%
 \def\switcharg{}%
 \def\switchalt{}%
 \glsxtrifhasfield{switch.#2}{useri}%
 {%
   \edef\switcharg{ \expandonce\glscurrentfieldvalue}%
 }%
 {}%
 \glsxtrifhasfield{switch.#2}{symbol}%
 {%
...
abbreviation mapped by \atentry{dualabbreviation}.\tabularnewline
...
using \csopt[long]{sort-field}. You can also tell \bibgls\ to
...
abbreviation style, the \csopt{sort-field} needs to be changed
...
field. The \atentry{symbol} and \atentry{number} entry types
