...
\begin{codeenv}
\atentry{preamble}\marg{"\cs{providecommand}\marg{\cmd{strong}}[1]\marg{\cs{textbf}\marg{\cmd{color}\marg{red}\idx{param}1}}
...
to:
\begin{codeenv}
\cs{textbf}\marg{\cmd{color}\marg{red}example (stuff)}
\end{codeenv}
...
\begin{codeenv}
\atentry{preamble}\marg{"\cs{providecommand}\marg{\gls{strong}}[1]\marg{\cs{textbf}\marg{\cmd{color}\marg{red}\idx{param}1}}"}
\end{codeenv}
