...
There are also some category attributes that govern abbreviations (see later).
These should be also set before the abbreviation is defined.
...
A distinction can be made between abbreviations
and non-abbreviations. A regular term is encapsulated with 
...
like a regular entry and so it's governed by \gls{glsxtrregularfont}
