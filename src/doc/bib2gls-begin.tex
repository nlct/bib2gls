...
\cmd{end}\marg{document}
\end{codeenv}
This is much neater, but maintaining the \filefmt{entries.tex} is
...
that defines the entries using \gls{newglossaryentry} or
\gls{newabbreviation}).
...
additional commands specific to \bibgls).
\end{itemize}
...
\filefmt{entries.bib} (regular entries), \filefmt{symbols.bib}
