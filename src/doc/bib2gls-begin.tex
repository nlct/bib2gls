...
\strut
\gls{newglossaryentry}\marg{bow}\marg{\field{name}=\marg{bow},\field{description}=\marg{}}
\strut
\gls{newglossaryentry}\marg{bowknot}
\marg{
  \field{parent} = \marg{bow},
...
This produces
\begin{result}
\glsaddeach{hom.bow,hom.bowknot,hom.bowweapon,%
...
\end{result}
The empty description for the top-level \code{bow} and
\code{glossary} entries has caused an odd effect with a space occurring 
between the name and the post-description punctuation. This can be removed by 
redefining:
