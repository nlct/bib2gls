...
\lstset{language={[LaTeX]TeX},upquote,basicstyle={\ttfamily},
 ...
 texcs={newglossaryentry,longnewglossaryentry,newabbreviation,newacronym,
  ...
  glsdefpostdesc,GlsXtrIfFieldEqXpStr,
...
{%
 \glslocalreseteach{TUG,ASCII,SIunit,CLDR,ex1.duck,ex1.goose,%
  ex2.duck,ex2.goose,ex.fleuron,ex.pi,ex.svm,ex.dante,ex.ssl,ex.xml,ex.gp,%
  ex2.gp}%
 \begin{quotation}%
 \marginpar
...
user keys: \field{user1}, \ldots, \field{user6}. The value of the
...
\gls{glssymbol} that obey the \idx{postlinkhook}, then use
...
\begin{lstlisting}[morekeywords={nationality,dateofbirth,gender,address}]
...
include the additional information (see \sectionref{sec:glsformats}
...
\glsdefpostname{general}{%
 ...
 (\glsentryuseri{\glscurrententrylabel}%
  \GlsXtrIfFieldEqXpStr{plural}{\glscurrententrylabel}%
...
\idx{regular} term.  There are also some category attributes that govern
