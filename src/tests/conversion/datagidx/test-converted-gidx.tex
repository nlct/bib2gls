% arara: pdflatex
% arara: bib2gls: { options: [ --force-cross-resource-refs ]}
% arara: pdflatex
% arara: bib2gls: { options: [ --force-cross-resource-refs ]}
% arara: pdflatex
\documentclass{book}
...
\newcommand*{\principleloc}[1]{\hyperbf{#1}}
\newcommand*{\glossaryloc}[1]{\hyperit{#1}}
...
\glsxtrprovidestoragekey{dependency}{}{}
...
\renewcommand\glsxtrbookindextarget[2]{\glsxtrtarget{#1}{#2}}
