...
\GlsXtrLoadResources[src={terms,animals,minerals,vegetables,interpret-preamble},
   %src=terms,
   sort={en-reverse},
  field-aliases={identifier=parent},
  selection={deps but not recorded}
]

\GlsXtrLoadResources[
  src={animals,minerals,vegetables,interpret-preamble},
