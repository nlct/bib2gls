...
{
   public FieldPrefixOfField(Field field1, Field field2)
   {
      this(field1, field2, false);
   }

   public FieldPrefixOfField(Field field1, Field field2, boolean negate)
   {
      this.field1 = field1;
      this.field2 = field2;
      this.negate = negate;
   ...
   public String toString()
   {
      return String.format("%s \\%s %s", 
        field1, negate ? "NOTPREFIXOF" : "PREFIXOF", field2);
   }
