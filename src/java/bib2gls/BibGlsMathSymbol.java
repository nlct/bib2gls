...
public class BibGlsMathSymbol extends L2HMathSymbol
{
   public BibGlsMathSymbol(String name, int codePoint, Bib2Gls bib2gls)
   {
   ...
   public Object clone()
   {
      return new BibGlsMathSymbol(getName(), getCharCode(), bib2gls);
   }
