 ...
 * value is not considered to be a suffix of another empty or
 * null value even though they may be considered equal.
 */
public class FieldSuffixOfField implements Conditional
{
   public FieldSuffixOfField(FieldValueElement fieldValueElem1,
   ...
   public String toString()
   {
      return String.format("%s \\%s %s", 
        fieldValueElem1, negate ? "NOTSUFFIXOF" : "SUFFIXOF", fieldValueElem2);
   }
