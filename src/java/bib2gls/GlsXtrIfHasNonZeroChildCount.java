...
public class GlsXtrIfHasNonZeroChildCount extends EntryFieldCommand
{
   ...
   public GlsXtrIfHasNonZeroChildCount(String name, 
     boolean defaultScope, Bib2Gls bib2gls)
   {
      super(name, bib2gls);
   }
   ...
   public Object clone()
   {
      return new GlsXtrIfHasNonZeroChildCount(getName(), defaultScope, bib2gls);
   }
      ...
      throws IOException
   {
      ...
      else
      {
         ...
         if (defaultScope)
         {
            ...
            Group grp = parser.getListener().createGroup();
            grp.add(new UserNumber(childcount));
            pending.add(grp);
         }
