...
public class NewGidx extends ControlSequence
{
   ...
   public NewGidx(String name, DataTool2Bib datatool2bib)
   {
      super(name);
   ...
   public Object clone()
   {
      return new NewGidx(getName(), datatool2bib);
   }
   ...
   {
      popOptArg(parser, stack); // options
      String dbname = popLabelString(parser, stack);
      popArg(parser, stack); // title

      datatool2bib.addGidxDatabase(dbname);
   }
